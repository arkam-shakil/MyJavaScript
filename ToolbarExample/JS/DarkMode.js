...
function darkMode()
{
	...
	if (ariaPressedValue === "false")
	{
		...
		$("body, main, h1, p, #messageFrame").attr("style", "background-color: black; color: white;");
		...
		$("body, main, h1, p, #messageFrame").removeAttr("style");
			document.getElementById("liveMessage").removeAttribute("style");
			document.getElementById("liveMessage").innerHTML = "Light Mode enabled.";
			setTimeout(function() {
			document.getElementById('liveMessage').innerHTML = '';
			document.getElementById("liveMessage").setAttribute("style", "display: none;");}, 2000);
	}
}